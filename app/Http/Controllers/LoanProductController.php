...
class LoanProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        GeneralHelper::audit_trail("New loan product created with ID:" . $loan_product->id);
    ...
    public function update(Request $request, $id)
    {
        ...
        GeneralHelper::audit_trail("Loan product updated with ID:" . $loan_product->id);
        Flash::success(trans('general.successfully_saved'));
        return redirect('loan/loan_product/data');
    }
    ...
    public function delete($id)
    {
        ...
        GeneralHelper::audit_trail("Loan product deleted with ID:" . $id);
