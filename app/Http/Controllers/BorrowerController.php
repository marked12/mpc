...
class BorrowerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        GeneralHelper::audit_trail("Client created with ID:" . $borrower->id);
    ...
    public function update(Request $request, $id)
    {
        ...
        GeneralHelper::audit_trail("Updated client with ID:" . $borrower->id);
        Flash::success(trans('general.successfully_saved'));
        return redirect('borrower/data');
    }
    ...
    public function delete($id)
    {
        ...
        GeneralHelper::audit_trail("Deleted customer with ID:" . $id);
    ...
    public function approve(Request $request, $id)
    {
        ...
        $borrower->active = 1;
        $borrower->save();
        GeneralHelper::audit_trail("Approved customer with ID:" . $borrower->id);
        Flash::success(trans('general.successfully_saved'));
    ...
    public function decline(Request $request, $id)
    {
        ...
        $borrower->active = 0;
        $borrower->save();
        GeneralHelper::audit_trail("Declined customer with ID:" . $borrower->id);
        Flash::success(trans('general.successfully_saved'));
        return redirect()->back();
    }
    public function blacklist(Request $request, $id)
    {
        ...
        $borrower->save();
        GeneralHelper::audit_trail("Blacklisted customer added with ID:" . $id);
        Flash::success(trans('general.successfully_saved'));
        return redirect()->back();
    }
    ...
    public function unBlacklist(Request $request, $id)
    {
        ...
        $borrower->save();
        GeneralHelper::audit_trail("Reverse blacklisted client with ID:" . $id);
        Flash::success(trans('general.successfully_saved'));
        return redirect()->back();
    }
}
