            ...
            <div class="table-responsive">
                <table id="repayments-data-table"
                    ...
                    <tr class="bg-success">
                        ...
                        <th>
                        {{trans_choice('general.client_name',1)}}
                        </th>                        
                        <th>
                         {{trans_choice('general.date',1)}} {{trans_choice('general.paid',1)}}
                        </th>
                        {{--<th>
                            {{trans_choice('general.collected_by',1)}}
                        </th>--}}
                        <th>
                            {{trans_choice('general.method',1)}} {{trans_choice('general.paid',1)}}
                        </th>
                        <th>
                                            ...
                                            @if($key->transaction_type=='repayment' && $key->reversible==1)
                                                <li>
                                                    <a href="{{url('loan/transaction/'.$key->id.'/print')}}"
                                                       target="_blank"><i
                                                                class="icon-printer"></i>{{trans_choice('general.imprint_vouchar',1)}}
                                                    </a></li>
                                                <li>
                                                    <a href="{{url('loan/transaction/'.$key->id.'/pdf')}}"
                                                       target="_blank"><i
                                                                class="icon-file-pdf"></i>{{trans_choice('general.download_pdf',1)}}
                                                    </a></li>
                                                <li>
                                                    <a href="{{url('loan/repayment/'.$key->id.'/edit')}}"><i
                                                                class="fa fa-edit"></i> {{trans_choice('general.edit_payment',1)}}
                                                    </a></li>
                                                <li>
                                                    <a href="{{url('loan/repayment/'.$key->id.'/reverse')}}"
                                                       class="delete"><i
                                                                class="fa fa-minus-circle"></i> {{trans_choice('general.reverse_paid',1)}}
                                                    </a></li>
                                            @endif
                                        </ul>
                                    </li>
