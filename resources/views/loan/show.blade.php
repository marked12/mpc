                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs bg-primary">
                        @if($loan->status=="disbursed" || $loan->status=="closed" || $loan->status=="withdrawn" || $loan->status=="written_off" || $loan->status=="rescheduled" )
                            <li class="active"><a href="#transactions" data-toggle="tab"
                                                  aria-expanded="true"><strong>{{trans_choice('general.transaction_history',1)}}</strong></a>
                            </li>
                            <li><a href="#loan_schedule" data-toggle="tab"
                                   aria-expanded="false"><strong>{{trans_choice('general.payment_schadule',1)}}</strong></a>
                            </li>
                    ...
                    <div class="tab-content">
                                                        ...
                                                        @foreach(\App\Models\LoanTransaction::where('loan_id',$loan->id)->whereIn('reversal_type',['user','none'])->get() as $key)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="display: none;">{{number_format($key->credit,2)}}</td>
                                                                    ...
                                                                    ?>
                                                                <td>
                                                                    <strong>{{number_format($value_amount_trxn,2)}}</strong>
                                                                </td>
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li>
                                                    <a href="{{url('loan/'.$loan->id.'/schedule/excel')}}"
                                                       target="_blank">{{trans_choice('general.download_excel',1)}}</a>
                                                </li>
                                ...
                                <div class="tab_content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-6"><h6>
                                                        <b>
                                                            <!--- --->{{trans_choice('general.last_payment',1)}}<!--- {{trans_choice('general.last',1)}} {{trans_choice('general.payment',1)}}
                                                            :---></b></h6></div>
                                                <div class="col-md-6">
                                                        <?php
                                                    ...
                                                    @if(!empty($last_payment))
                                                        <h6><b>₱ {{number_format($last_payment->credit)}}
                                                                {{trans_choice('general.on_date',1)}} {{$last_payment->date}}</b>
                                                        </h6>
                                                    @else
                                                        ----
                                                    @endif
                                            ...
                                            <div class="row">
                                                <div class="col-md-6"><h6>
                                                        <b>
                                                            <!--- --->{{trans_choice('general.next_payment',1)}}<!--- {{trans_choice('general.next',1)}} {{trans_choice('general.payment',1)}}
                                                            :---></b></h6></div>
                                                <div class="col-md-6">
                                                        <?php
                                                        $count = \App\Models\LoanSchedule::where('due_date', '<=',
                                    ...
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tr class="bg-danger">
                                            <th width="200">
                                                <b>
                                                    <!--- --->{{trans_choice('general.balance',1)}}<!--- {{trans_choice('general.item',1)}}
                                                    :---></b>
                                            </th>
                                            <th style="text-align:right;">
                                                <b>
                                                    <!--- --->{{trans_choice('general.capital',1)}}<!---{{trans_choice('general.principal',1)}}---></b>
                                            </th>
                                            <th style="text-align:right;">
                                                <b>
                                                    <!--- --->{{trans_choice('general.interest',1)}}<!--- {{trans_choice('general.interest',1)}}---></b>
                                            </th>
                                            <th style="text-align:right;">
                                                <b>
                                                    <!--- --->{{trans_choice('general.paid',1)}}<!--- {{trans_choice('general.fee',2)}}---></b>
                                            </th>
                                            <th style="text-align:right;">
                                                <b>
                                                    <!--- --->{{trans_choice('general.more',1)}}<!--- {{trans_choice('general.penalty',1)}}---></b>
                                            </th>
                                            <th style="text-align:right;">
                                                <b>
                                                    <!--- --->{{trans_choice('general.total',1)}}<!--- {{trans_choice('general.total',1)}}---></b>
                                            </th>
                                        </tr>
                                        <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    @if(Sentinel::hasAccess('loans.writeoff'))
                                                        <li>
                                                            <a href="#" class=""
                                                               data-toggle="modal"
                                                               data-target="#writeoffLoan">{{trans_choice("Lead to Loss",1)}}</a>
                                                        </li>
                                                    @endif
                                            ...
                                            @endif--->
                                                        ...
                                                        @if(Sentinel::hasAccess('loans.update'))
                                                            <li>
                                                                <a href="#" class=""
                                                                   data-toggle="modal"
                                                                   data-target="#waiveInterest">{{trans_choice("Exclude Interest",1)}}</a>
                                                            </li>
                                                        @endif
                                                        @if(Sentinel::hasAccess('loans.update'))
                                                            <li>
                                                                <a href="#" class=""
                                                                   data-toggle="modal"
                                                                   data-target="#addCharge">{{trans_choice("Add Interest",1)}}</a>
                                                            </li>
                                                        @endif
                                                </ul>
                                            </div>
                            ...
                            <div class="panel-body no-padding">
                                <table class="table table-condensed">
                                    ...
                                    <tr>
                                        <td>
                                            <b>
                                                <!-- -->{{trans_choice('general.loan_status',1)}} <!-- {{trans_choice('general.loan',1)}} {{trans_choice('general.status',1)}}--></b>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="200">
                                            <b>
                                                <!-- -->{{trans_choice('general.loan_number',1)}}<!-- {{trans_choice('general.loan',1)}} {{trans_choice('general.application',1)}} {{trans_choice('general.id',1)}}--></b>
                                        </td>
                                        <td>000{{$loan->id}}</td>
                                ...
                                <td colspan="2" class="bg-navy disabled color-palette">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <b>
                                                <!-- -->{{trans_choice('general.disbursement_date',1)}}<!-- {{trans_choice('general.loan',1)}} {{trans_choice('general.release',1)}} {{trans_choice('general.date',1)}}--></b>
                                        </td>
                                        <td>
                                                <?php
                                    ...
                                    <tr>
                                        <td>
                                            <b>
                                                <!-- -->{{trans_choice('general.interest_rate',1)}}<!-- {{trans_choice('general.loan',1)}} {{trans_choice('general.interest',1)}}--></b>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <b>
                                                <!-- -->{{trans_choice('general.duration',1)}}<!-- {{trans_choice('general.loan',1)}} {{trans_choice('general.duration',1)}}--></b>
                                        </td>
                                    ...
                                    <tr>
                                        <td><b>
                                                <!-- -->{{trans_choice('general.repayment_cycle',1)}}<!-- {{trans_choice('general.repayment_cycle',1)}}--></b>
                                        </td>
                                        <td>
                                            @if($loan->repayment_cycle=='daily')
                                                {{trans_choice('general.daily',1)}}
                                    ...
                                    <tr>
                                        <td><b>
                                                <!-- -->{{trans_choice('general.amount_payment',1)}}<!-- {{trans_choice('general.number',1)}}
                            ...
                            <td>
                                @if($loan->decimal_places=='round_off_to_two_decimal')
                                    ...
                                    <tr>
                                        <td>
                                            <b>
                                                <!-- -->{{trans_choice('general.start_paying',1)}}<!-- {{trans_choice('general.first',1)}} {{trans_choice('general.repayment',1)}} {{trans_choice('general.date',1)}}--></b>
                                        </td>
                                        <td>
                                                <?php
                        ...
                        <div class="tab-pane" id="loan_files">
                            <p>{{trans_choice('general.to_add_or_delete_loan_file',1)}}
                                <b>{{trans_choice('general.loan_term',1)}}</b> {{trans_choice('general.tab_and_then',1)}}
