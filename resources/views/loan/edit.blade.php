    ...
    <div class="panel panel-white">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    {!! Form::select('loan_duration_type',array('month'=>trans_choice('general.month',1)),$loan->loan_duration_type, array('class' => 'form-control', 'placeholder'=>"","id"=>"inputMaxInterestPeriod",'required'=>'required')) !!}
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    {!! Form::select('repayment_cycle',array('daily'=>trans_choice('general.daily',1),'weekly'=>trans_choice('general.weekly',1),'bi_monthly'=>trans_choice('general.bi_monthly',1),'monthly'=>trans_choice('general.monthly',1)),$loan->repayment_cycle, array('class' => 'form-control', 'placeholder'=>"","id"=>"",'required'=>'required')) !!}
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
<!---{!! Form::select('interest_method',array('flat_rate'=>trans_choice('general.flat_rate',1)),$loan->interest_method, array('class' => 'form-control', 'placeholder'=>"Seleccione",'required'=>'required')) !!}--->
...
{{--                </div>--}}
                ...
                <div class="col-sm-9">
                    @foreach(unserialize($loan->files) as $key=>$value)
                        <span id="file_{{$key}}_span"> Files Uploaded: <a href="{!!asset('uploads/'.$value)!!}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <input type="checkbox" @if($loan->includes_sat == 1) checked @endif name="includes_sat" value="yes" class="form-control" style="width: 20px;">                    
                </div>
                <div class="col-sm-4">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <input type="checkbox" @if($loan->includes_sun == 1) checked @endif name="includes_sun" value="yes"  class="form-control" style="width: 20px;">
                </div>
                <div class="col-sm-4">
                </div>
            </div>
