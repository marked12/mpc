...
@section('title')
    {{trans_choice('general.app_name',1)}} | {{trans_choice('general.adit_route',1)}}
@endsection
@section('content')
    <div class="panel panel-white">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    {!! Form::select('accounting_rule',['cash_based'=>trans_choice('general.cash_based',1)],$loan_product->accounting_rule, array('class' => 'form-control select2','required'=>'required','id'=>'accounting_rule')) !!}
                </div>
                <div class="col-sm-3">
                    <i class="icon-info3" data-toggle="tooltip"
