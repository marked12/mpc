...
@section('title')
    {{trans_choice('general.app_name',1)}} | {{trans_choice('general.new_client',1)}}
@endsection
@section('content')
<!---{{trans_choice('general.add',1)}} {{trans_choice('general.borrower',1)}}--->
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        {!! Form::select('title',array('Select to choose'=>trans_choice('general.Select to choose',1),'Mr'=>trans_choice('general.Mr',1),'Mrs'=>trans_choice('general.Mrs',1), 'Miss'=>trans_choice('general.Miss',1),'Ms'=>trans_choice('general.Ms',1),'Prof'=>trans_choice('general.Prof',1)),'Mr', array('class' => 'form-control',)) !!}
                    </div>
                    <div class="col-md-4">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        {!! Form::select('working_status',array('Employee'=>trans_choice('general.Employee',1)),null, array('class' => 'form-control',)) !!}
                    </div>
                    <div class="col-md-4">
            ...
            <p style="display: none;" class="bg-navy disabled color-palette">{{trans_choice('general.login',1)}} {{trans_choice('general.detail',2)}}</p>
